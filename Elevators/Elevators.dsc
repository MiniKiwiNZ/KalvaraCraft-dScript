...
dElevators_world:
    ...
    data:
        ...
        #SafeBlocks:
        #- air
        #- vanilla_tagged:carpets
        #- snow
        #- vanilla_tagged:signs
        #- ladder
        #- torch
        #- vines
        #- lever
    ...
    events:
        ...
        - define elevators <context.location.chunk.flag[dElevators.<context.location.block.x>-<context.location.block.z>].alphanumeric>
        # Determine which elevator the player is standing on
        - define index <[elevators].find[<context.location.block.y>]>
        ...
        # If the player isn't standing on an elevator, remove the bossbar
        - if <context.location.has_flag[dElevator].not>:
        ...
        - else if <player.standing_on.material.advanced_matches[vanilla_tagged:carpets].if_null[false]> && <player.standing_on.below[1].has_flag[dElevator].if_null[false]>:
