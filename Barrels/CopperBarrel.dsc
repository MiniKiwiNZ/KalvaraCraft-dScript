dbarrel_item_copper:
  ...
  material: barrel
  debug: false
  display name: <white>Copper Barrel
  data:
    stacks: 64
    icon: copper_block
  lore:
  - <dark_purple><italic>Compact storage solution for bulk items
  - <dark_purple><italic>Can hold 64 stacks of one item
  - <empty>
  - <gold>[Storage]
  recipes:
    ...
    1:
      ...
      - copper_block|dbarrel_item_wood|copper_block
      - copper_ingot|copper_block|copper_ingot
    ...
    2:
      ...
      input:
      - copper_ingot|copper_block|copper_ingot
      - copper_block|material:barrel|copper_block
      - copper_ingot|copper_block|copper_ingot

dbarrel_world_copper:
  type: world
  debug: false
  events:
    on dbarrel_item_copper recipe formed:
    # Check that it's the correct type of barrel for the upgrade
    - if !<context.recipe.get[5].advanced_matches[dbarrel_item_wood]>:
      - determine cancelled
