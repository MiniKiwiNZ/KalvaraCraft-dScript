dbarrel_item_iron:
  ...
  material: barrel
  debug: false
  display name: <white>Iron Barrel
  data:
    stacks: 128
    icon: iron_block
  lore:
  - <dark_purple><italic>Compact storage solution for bulk items
  - <dark_purple><italic>Can hold 128 stacks of one item
  - <empty>
  - <gold>[Storage]
  recipes:
    ...
    1:
      ...
      - iron_block|dbarrel_item_copper|iron_block
      - iron_ingot|iron_block|iron_ingot
    ...
    2:
      ...
      input:
      - iron_ingot|iron_block|iron_ingot
      - iron_block|material:barrel|iron_block
      - iron_ingot|iron_block|iron_ingot
...
dbarrel_world_iron:
  ...
  debug: false
  events:
    on dbarrel_item_iron recipe formed:
    # Check that it's the correct type of barrel for the upgrade
    - if !<context.recipe.get[5].advanced_matches[dbarrel_item_copper]>:
      - determine cancelled
