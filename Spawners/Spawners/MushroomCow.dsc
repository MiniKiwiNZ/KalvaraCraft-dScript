dSpawners_Spawner_MushroomCow:
  ...
  display name: <yellow>Mooshroom <green>Spawner
  lore:
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_3|dSpawners_SpawnerCore_MushroomCow|dSpawners_SpawnerShard_3
      - air|dSpawners_SpawnerShard_3|air
dSpawners_Spawner_MushroomCow_Register:
  type: world
  debug: false
  events:
