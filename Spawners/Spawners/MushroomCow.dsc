AR_Spawner_MushroomCow:
  ...
  recipes:
    1:
      ...
      - AR_SpawnerShard_3|AR_SpawnerCore_MushroomCow|AR_SpawnerShard_3
      - air|AR_SpawnerShard_3|air
AR_Spawner_MushroomCow_Register:
  type: world
  debug: false
  events:
    on custom event id:ar_register_spawner_modules:
      - run AR_Spawners_registerSpawner def:MUSHROOM_COW|AR_Spawner_MushroomCow
      - run AR_Spawners_registerSpawner def:MUSHROOMCOW|AR_Spawner_MushroomCow
      - run AR_Spawners_registerSpawner def:MOOSHROOM|AR_Spawner_MushroomCow