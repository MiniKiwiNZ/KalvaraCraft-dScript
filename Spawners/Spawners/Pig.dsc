dSpawners_Spawner_Pig:
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_1|dSpawners_SpawnerCore_Pig|dSpawners_SpawnerShard_1
      - dSpawners_SpawnerShard_1|dSpawners_SpawnerShard_1|dSpawners_SpawnerShard_1
dSpawners_Spawner_Pig_Register:
  type: world
  debug: false
  events:
    on custom event id:dspawners_register_spawner_modules:
      - run dSpawners_Spawners_registerSpawner def:PIG|dSpawners_Spawner_Pig