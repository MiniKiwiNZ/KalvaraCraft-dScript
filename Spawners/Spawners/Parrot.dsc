AR_Spawner_Parrot:
    ...
    Upgrades:
      ...
      LootMultiplier:
        ...
        Cost:
          ...
          - AR_SpawnerShard_4[quantity=1]
          - AR_SpawnerCore_Parrot
          - feather[quantity=128]
          3:
          - AR_SpawnerShard_4[quantity=2]
          - AR_SpawnerCore_Parrot
          - feather[quantity=256]
          4:
          - AR_SpawnerShard_4[quantity=2]
          - AR_SpawnerCore_Parrot
  ...
  recipes:
    1:
      ...
      - AR_SpawnerShard_1|AR_SpawnerCore_Parrot|AR_SpawnerShard_1
      - AR_SpawnerShard_1|AR_SpawnerShard_1|AR_SpawnerShard_1
AR_Spawner_Parrot_Register:
  type: world
  debug: false
  events:
    on custom event id:ar_register_spawner_modules:
      - run AR_Spawners_registerSpawner def:PARROT|AR_Spawner_Parrot