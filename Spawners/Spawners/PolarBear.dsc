AR_Spawner_PolarBear:
  ...
  recipes:
    1:
      ...
      - AR_SpawnerShard_1|AR_SpawnerCore_PolarBear|AR_SpawnerShard_1
      - AR_SpawnerShard_1|AR_SpawnerShard_1|AR_SpawnerShard_1
AR_Spawner_PolarBear_Register:
  type: world
  debug: false
  events:
    on custom event id:ar_register_spawner_modules:
      - run AR_Spawners_registerSpawner def:POLAR_BEAR|AR_Spawner_PolarBear
      - run AR_Spawners_registerSpawner def:POLARBEAR|AR_Spawner_PolarBear