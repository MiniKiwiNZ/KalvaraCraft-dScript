dSpawners_Spawner_Chicken:
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerCore_Chicken|dSpawners_SpawnerShard_2
      - dSpawners_SpawnerShard_2|air|dSpawners_SpawnerShard_2
    2:
      type: shaped
      input:
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
      - air|dSpawners_SpawnerCore_Chicken|air
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
dSpawners_Spawner_Chicken_Register:
  type: world
  debug: false
  events:
