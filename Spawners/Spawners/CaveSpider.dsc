dSpawners_Spawner_CaveSpider:
  ...
  display name: <yellow>Cave Spider <green>Spawner
  lore:
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_3|dSpawners_SpawnerCore_CaveSpider|dSpawners_SpawnerShard_3
      - air|dSpawners_SpawnerShard_3|air
dSpawners_Spawner_CaveSpider_Register:
  type: world
  debug: false
  events:
