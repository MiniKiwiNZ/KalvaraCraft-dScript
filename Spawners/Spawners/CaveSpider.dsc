AR_Spawner_CaveSpider:
    ...
    Upgrades:
      ...
      LootMultiplier:
        ...
        Cost:
          ...
          - spider_eye[quantity=64]
          2:
          - AR_SpawnerShard_4[quantity=3]
          - AR_SpawnerCore_CaveSpider
          - spider_eye[quantity=128]
          3:
          - AR_SpawnerShard_4[quantity=6]
          - AR_SpawnerCore_CaveSpider
          - spider_eye[quantity=256]
          4:
          - AR_SpawnerShard_4[quantity=6]
          - AR_SpawnerCore_CaveSpider
  ...
  recipes:
    1:
      ...
      - AR_SpawnerShard_3|AR_SpawnerCore_CaveSpider|AR_SpawnerShard_3
      - air|AR_SpawnerShard_3|air
AR_Spawner_CaveSpider_Register:
  type: world
  debug: false
  events:
    on custom event id:ar_register_spawner_modules:
      - run AR_Spawners_registerSpawner def:CAVE_SPIDER|AR_Spawner_CaveSpider
      - run AR_Spawners_registerSpawner def:CAVESPIDER|AR_Spawner_CaveSpider