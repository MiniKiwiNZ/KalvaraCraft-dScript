AR_Spawner_Horse:
  ...
  recipes:
    1:
      ...
      - AR_SpawnerShard_2|AR_SpawnerCore_Horse|AR_SpawnerShard_2
      - AR_SpawnerShard_2|air|AR_SpawnerShard_2
    2:
      type: shaped
      input:
      - AR_SpawnerShard_2|AR_SpawnerShard_2|AR_SpawnerShard_2
      - air|AR_SpawnerCore_Horse|air
      - AR_SpawnerShard_2|AR_SpawnerShard_2|AR_SpawnerShard_2
AR_Spawner_Horse_Register:
  type: world
  debug: false
  events:
    on custom event id:ar_register_spawner_modules:
      - run AR_Spawners_registerSpawner def:HORSE|AR_Spawner_Horse