dSpawners_Spawner_Rabbit:
    ...
    Upgrades:
      ...
      LootMultiplier:
        ...
        Cost:
          ...
          - rabbit_hide[quantity=64]
          2:
          - dSpawners_SpawnerShard_4[quantity=2]
          - dSpawners_SpawnerCore_Rabbit
          - rabbit_hide[quantity=128]
          3:
          - dSpawners_SpawnerShard_4[quantity=4]
          - dSpawners_SpawnerCore_Rabbit
          - rabbit_hide[quantity=256]
          4:
          - dSpawners_SpawnerShard_4[quantity=4]
          - dSpawners_SpawnerCore_Rabbit
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerCore_Rabbit|dSpawners_SpawnerShard_2
      - dSpawners_SpawnerShard_2|air|dSpawners_SpawnerShard_2
    2:
      type: shaped
      input:
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
      - air|dSpawners_SpawnerCore_Rabbit|air
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
dSpawners_Spawner_Rabbit_Register:
  type: world
  debug: false
  events:
    on custom event id:dspawners_register_spawner_modules:
      - run dSpawners_Spawners_registerSpawner def:RABBIT|dSpawners_Spawner_Rabbit