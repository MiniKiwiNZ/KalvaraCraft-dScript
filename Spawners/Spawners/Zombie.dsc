dSpawners_Spawner_Zombie:
    ...
    Upgrades:
      ...
      LootMultiplier:
        ...
        Cost:
          ...
          - rotten_flesh[quantity=64]
          2:
          - dSpawners_SpawnerShard_4[quantity=1]
          - dSpawners_SpawnerCore_Zombie
          - rotten_flesh[quantity=128]
          3:
          - dSpawners_SpawnerShard_4[quantity=2]
          - dSpawners_SpawnerCore_Zombie
          - rotten_flesh[quantity=256]
          4:
          - dSpawners_SpawnerShard_4[quantity=2]
          - dSpawners_SpawnerCore_Zombie
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_1|dSpawners_SpawnerCore_Zombie|dSpawners_SpawnerShard_1
      - dSpawners_SpawnerShard_1|dSpawners_SpawnerShard_1|dSpawners_SpawnerShard_1
dSpawners_Spawner_Zombie_Register:
  type: world
  debug: false
  events:
    on custom event id:dspawners_register_spawner_modules:
      - run dSpawners_Spawners_registerSpawner def:ZOMBIE|dSpawners_Spawner_Zombie