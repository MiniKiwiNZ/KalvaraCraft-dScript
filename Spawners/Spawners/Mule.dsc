dSpawners_Spawner_Mule:
  ...
  recipes:
    1:
      ...
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerCore_Mule|dSpawners_SpawnerShard_2
      - dSpawners_SpawnerShard_2|air|dSpawners_SpawnerShard_2
    2:
      type: shaped
      input:
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
      - air|dSpawners_SpawnerCore_Mule|air
      - dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2|dSpawners_SpawnerShard_2
dSpawners_Spawner_Mule_Register:
  type: world
  debug: false
  events:
